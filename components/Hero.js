...
export default function Hero(){
    return(
        <div className="bg-hero 2xl:h-[712px] lg:h-[600px] ls:h[550px] md:h-[500px] pb-20">
            <div className="container mx-auto px-10 2xl:px-0">
            <Navbar />
                <div className="text-center xl:mt-20 lg:mt-10 md:mt-6">
                    <h1 className="text-white text-3xl font-semibold font-mono 2xl:w-6/12 xl:w-8/12 lg:w-10/12 mx-auto leading-relaxed">Saya seorang front-end engineer, back-end engineer, dan juga UI designer</h1>
